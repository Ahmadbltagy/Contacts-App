<div class="row">
  <div class="col-md-12">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9">
        <textarea name="address" id="address" rows="3"  class="form-control @error('last_name') is-invalid @enderror"> {{old('address', $contact->address)}}</textarea>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9">
        <select name="company_id" id="company_id" class="form-control">
          ...
          <option {{ $id == old('company_id', $contact->company_id)? 'selected': '' }} value="{{$id}}">{{$value}}</option>
          @endforeach
